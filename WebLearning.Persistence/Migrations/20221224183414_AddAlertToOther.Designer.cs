...
namespace WebLearning.Persistence.Migrations
{
    ...
    [Migration("20221224183414_AddAlertToOther")]
    partial class AddAlertToOther
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebLearning.Domain.Entites.Alert", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid>("LessionVideoId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("WebLearning.Domain.Entites.Alert", b =>
                {
                    b.HasOne("WebLearning.Domain.Entites.Course", "Course")
                        .WithOne("Alert")
                        .HasForeignKey("WebLearning.Domain.Entites.Alert", "CourseId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
