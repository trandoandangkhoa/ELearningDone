...
{
    public class UpdateQuizLessionValidation : AbstractValidator<UpdateQuizLessionDto>
    {
        public UpdateQuizLessionValidation()
        {
            ...
            RuleFor(ls => ls.Description).NotEmpty().WithMessage("Vui lòng điền nội dung bài kiểm tra cho từng bài học!");
        }
    }
}
