...
{
    public class CreateQuizCourseValidation : AbstractValidator<CreateQuizCourseDto>
    {
        public CreateQuizCourseValidation()
        {
            ...
            RuleFor(ls => ls.CourseId).NotNull().NotEmpty().WithMessage("Vui lòng chọn khóa học kiểm tra!");
